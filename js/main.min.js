...
createEvent(form, "submit", function(e){
	createChecker(userName, {
		"valueMissing": "Нужно ввести Имя",
		"patternMismatch": "Шаблон имени не соответствует заданному"
	});

	createChecker(email, {
		"valueMissing": "Нужно ввести почту",
		"patternMismatch": "Шаблон не соответсвует заданному"
	});
